            ...
            <div className="mb-6">
              <div className="bg-transparent rounded-xl p-6">
                <div className="max-w-[1400px] mx-auto flex items-center justify-between">
                  <div>
                    <h1 className="text-3xl font-semibold text-gray-900">Bulk Booking</h1>
                    <p className="text-sm text-gray-600 mt-1">Add multiple appointments and pay once</p>
                  </div>

                  <div>
                    <Link href="/BulkBooking/add" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-xl shadow-md">
                ...
                <div className="col-span-9">
                  <div className="bg-white rounded-xl shadow-lg p-8 h-96 flex flex-col items-center justify-center">
                    <div className="text-center text-gray-400">
                      ...
                      <p className="text-lg font-semibold text-gray-800 mb-3">No appointments in cart yet</p>
                      <p className="text-sm text-gray-600 mb-6">Add appointments to the booking cart and pay once for all.</p>
                      <Link href="/BulkBooking/add" className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg shadow-md inline-flex items-center gap-2">
                        <span className="text-lg font-bold">+</span>
                        <span className="font-semibold">Add First Appointment</span>
                      </Link>
                    </div>
                  </div>
                </div>
