...
function PersonalInfoForm() {
  ...
  return (
    <div className="bg-white p-8 rounded-2xl shadow-md flex-1">
      <h3 className="font-semibold text-gray-800 mb-4 text-lg">Personal Information</h3>

      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm text-gray-500">First Name</label>
          <div className="mt-1 relative">
            <svg className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <input value={formData.firstName} className="w-full border rounded-lg p-3 pl-10 text-base focus:ring-2 focus:ring-green-400" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-1 relative">
            ...
            <input value={formData.lastName} className="w-full border rounded-lg p-3 pl-10 text-base focus:ring-2 focus:ring-green-400" />
          </div>
        </div>
      </div>
      ...
      <div className="mt-4">
        ...
        <div className="mt-1 relative">
          <svg className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-800" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <input value={formData.email} className="w-full border rounded-lg p-3 pl-10 text-base focus:ring-2 focus:ring-green-400" />
        </div>
      </div>
  ...
  />
          ...
          <input value={formData.phone} className="w-full border rounded-lg p-3 pl-10 text-base focus:ring-2 focus:ring-green-400" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white p-8 rounded-2xl shadow-md">
      ...
      <div className="mb-3">
        ...
        <input type="password" className="w-full mt-1 border rounded-lg p-3 text-base focus:ring-2 focus:ring-green-400" />
      </div>
      ...
      <div className="flex justify-end">
        <button
          className="px-8 py-3 rounded-full bg-gradient-to-r from-[#23DE4F] to-[#330FFB] text-white font-medium hover:opacity-95 transition transform hover:shadow-md active:scale-95"
        >
          Change Password
        </button>
      </div>
...
function NotificationPreferences() {
  ...
  const items = [
    ...
    },
    {
      ...
      icon: (
        <svg className="h-7 w-7 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4-.84L3 20l1.16-4.36A7.966 7.966 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
        </svg>
      ),
    },
  ];
  ...
  return (
    <div className="bg-white p-8 rounded-2xl shadow-md flex-1">
      <h3 className="font-semibold text-gray-800 mb-4 text-lg">Notification Preferences</h3>
