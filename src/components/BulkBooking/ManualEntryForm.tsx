    ...
    <div className="space-y-5">
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
        <div className="grid grid-cols-3 gap-4 p-5 bg-white">
          <div>
            ...
            <select
              ...
              onChange={(e) => setTopFormData({ ...topFormData, doctor: e.target.value })}
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setTopFormData({ ...topFormData, specialization: e.target.value })}
              className="w-full border border-gray-300 rounded px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setTopFormData({ ...topFormData, dateTime: e.target.value })}
        ...
        <div className="px-5 pb-5">
          <button
            onClick={addNewForm}
            className="px-8 py-3 rounded-md bg-gradient-to-r from-green-500 to-blue-600 text-white font-semibold text-sm hover:shadow-lg transition-all inline-flex items-center gap-2"
          >
      ...
      {openFormIds.map((formId, index) => {
        ...
        return (
          <div key={formId} className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="p-5">
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <select
                    value={form.doctor}
                    onChange={(e) => updateForm(formId, "doctor", e.target.value)}
                    className="w-full border border-gray-300 rounded px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  >
                    <option value="">Select Doctor</option>
                    {doctors.map((d) => (
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateForm(formId, "patientName", e.target.value)}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateForm(formId, "patientNIC", e.target.value)}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateForm(formId, "patientPhone", e.target.value)}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateForm(formId, "patientEmail", e.target.value)}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateForm(formId, "paymentMethod", e.target.value)}
                    className="w-full border border-gray-300 rounded px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  >
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">SLT Phone Number</label>
                  <input
                    type="text"
                    value={form.sltPhone}
                    onChange={(e) => updateForm(formId, "sltPhone", e.target.value)}
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-gray-800 text-base">Ready to Submit</p>
                <p className="text-sm text-gray-600">
                  {totalAppointments} appointment{totalAppointments > 1 ? "s" : ""} ready for booking
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={bookAll}
                className="px-6 py-2.5 rounded-md bg-gradient-to-r from-green-500 to-blue-600 text-white font-semibold hover:shadow-lg transition text-sm"
              >
