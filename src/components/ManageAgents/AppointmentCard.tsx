...
//             <p className="text-2xl font-bold text-blue-600">Rs. {appointment.amount}</p>
//             <p className="text-sm text-gray-500">{appointment.refundable ? 'Refundable' : 'Non-refundable'}</p>
//           </div>

//           <button
//             onClick={() => onViewDetails(appointment)}
//             className="px-6 py-2 border-2 border-blue-600 text-blue-600 rounded-xl hover:bg-blue-50 transition-colors font-medium"
//           >
//             View
//           </button>
//         </div>
