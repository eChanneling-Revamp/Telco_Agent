...
const pool = new Pool({
  connectionString: process.env.DATABASE_URL || 'postgresql://neondb_owner:npg_ibV06KmfCNsk@ep-square-sun-a4y96x44-pooler.us-east-1.aws.neon.tech/neondb?sslmode=require',
  ssl: {
...
async function initAppointmentTables() {
  try {
    ...
    await pool.query(`
      ...
      ON CONFLICT DO NOTHING;
    `);
    console.log('✅ Sample availability inserted!');
